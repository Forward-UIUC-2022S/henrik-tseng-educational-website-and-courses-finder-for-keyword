...
feature_names = ['Keyword', 'index', 'url', 'org', 'edu', 'com', 'else', 'keyword in entry', 'entry length', 'tutorial', 'wiki',
                 'introduction', 'course', 'class', 'lecture', 'video', 'graph', 'diagram', 'book', 'keyword_count', 'content_length',
                 'content_diagram', 'content_example', 'content_formula', 'content_graph', 'content_code', 'content_video', 'content_book', 'label']
...
def DataCollection(keyword,result_num = 10):
